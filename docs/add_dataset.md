...
From the `my_dataset/` directory, run `tfds build` to generate the dataset:
...
See the
[CLI documentation](https://www.tensorflow.org/datasets/cli#tfds_build_generating_a_dataset).
